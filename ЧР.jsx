...
(function () {
  ...
  // Лейблы: Гол/Голы, Предупреждения, Удаление/Удаления, Судья
  var RE_LABEL = /^(Голы?|Предупреждения|Удалени[ея]|Судья)\s*:/i;
      ...
      if (p0 && p0.isValid) {
        ...
        for (var i2 = 0; i2 < totalParas; i2++) {
          ...
          try {
            ...
            // --- Лейблы: Гол(ы), Предупреждения, Удаление/Удаления, Судья → bold до двоеточия ---
